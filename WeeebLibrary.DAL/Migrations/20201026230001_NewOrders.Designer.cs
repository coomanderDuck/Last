...
namespace WeeebLibrary.DAL.Migrations
{
    ...
    [Migration("20201026230001_NewOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeeebLibrary.DAL.Database.Entitys.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("WeeebLibrary.DAL.Database.Entitys.Order", b =>
                {
                    ...
                    b.Property<DateTime>("СanceledTime")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("WeeebLibrary.DAL.Database.Entitys.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WeeebLibrary.DAL.Database.Entitys.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeeebLibrary.DAL.Database.Entitys.Order", b =>
                {
                    b.HasOne("WeeebLibrary.DAL.Database.Entitys.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeeebLibrary.DAL.Database.Entitys.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
